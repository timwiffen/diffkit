...
public class TestCaseRun {
   ...
   private Boolean getDiffFailed(){
      ...
      if(expectedContent != null && actualContent != null) {
         String tzName = " " + TimeZone.getDefault().getDisplayName(false, TimeZone.SHORT) + " "
        _failed = ! StringUtils.equals( expectedContent.replace(" EST ", tzName).replaceAll("\\r\\n", '\n'), actualContent.replaceAll("\\r\\n", '\n'))
      } else {
